...
export type DescOverride = { date: string; town: string; title: string; desc: string; addedBy: string };
...
export async function addDescOverride(override: DescOverride): Promise<void> {
