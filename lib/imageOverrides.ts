...
export type ImageOverride = { date: string; town: string; title: string; image: string; addedBy: string };
...
export async function addImageOverride(override: ImageOverride): Promise<void> {
